    ...
    def list(self, request, *args, **kwargs):
        try:
            ...
            # ✅ Case 2: Filter by activity (MOST IMPORTANT)
                ...
                return ApiResponse(
                    status=status.HTTP_200_OK,
                    message="Images for activity." if images.exists() else "No images for this activity.",
                    data=serializer.data,
                    http_status=status.HTTP_200_OK
                ).create_response()
            ...
            # ✅ Case 3: Filter by project
                ...
                return ApiResponse(
                    status=status.HTTP_200_OK,
                    message="Images found for project." if images.exists() else "No images for this project.",
                    data=serializer.data,
                    http_status=status.HTTP_200_OK
                ).create_response()
